...
export function SurfaceHeader({
  ...
  if (heroImage) {
    return (
      <header className="w-screen relative left-1/2 -translate-x-1/2 -mt-8 sm:-mt-12 md:-mt-14 lg:-mt-16 mb-12 md:mb-14 lg:mb-16">
        {/* Full-bleed hero */}
        <div className="relative h-[36vh] md:h-[44vh] lg:h-[52vh] xl:h-[60vh] min-h-[320px] md:min-h-[380px] lg:min-h-[440px]">
          <ParallaxImage
            src={heroImage}
            alt=""
        ...
        <div className="relative max-w-[1400px] mx-auto px-5 sm:px-8 md:px-10 lg:px-12 xl:px-16 2xl:px-20 -mt-20 sm:-mt-24 md:-mt-28">
  ...
  return (
    <header className="max-w-[1400px] mx-auto mb-12 md:mb-14 lg:mb-16">
