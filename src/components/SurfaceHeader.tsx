...
export function SurfaceHeader({
  ...
  if (heroImage) {
    return (
      <header className="bleed -mt-8 sm:-mt-12 md:-mt-14 lg:-mt-16 mb-12 md:mb-14 lg:mb-16">
        {/* Full-bleed hero */}
        <div className="relative h-[42vh] md:h-[44vh] lg:h-[52vh] xl:h-[60vh] min-h-[280px] sm:min-h-[320px] md:min-h-[380px] lg:min-h-[440px]">
          <ParallaxImage
            src={heroImage}
            alt=""
        ...
        {/* Glass card aligned to layout-frame */}
        <div className="relative layout-frame -mt-20 sm:-mt-24 md:-mt-28">
          <div className="bg-white/80 backdrop-blur-xl border border-[rgba(74,144,168,0.12)] rounded-3xl shadow-[0_2px_24px_rgba(26,41,53,0.06)] p-5 md:p-7 lg:p-10">
  ...
  return (
    <header className="layout-frame-flush mb-12 md:mb-14 lg:mb-16">
