...
export const biomarkers: Biomarker[] = [
  { id: "bio_01", marker: "Vitamin D", value: 62, unit: "nmol/L", takenAt: "2026-04-10", optimalLow: 40, optimalHigh: 80 },
...
export const staff: StaffMember[] = [
  {
    ...
    bioOneLine: "Trained in pranayama in Rishikesh. Surfs the cliff below the resort at dawn.",
    shift: "on",
    photoSeed: "ws",
    isOliviasTeam: true,
  },
  {
    ...
    bioOneLine: "Twenty years in metabolic medicine. Believes mornings are the only protocol that compounds.",
    shift: "responding",
    photoSeed: "lm",
    isOliviasTeam: true,
  },
  {
    ...
    bioOneLine: "Former pastry lead at Locavore. Ferments everything. Refuses to label anything 'wellness food'.",
    shift: "on",
    photoSeed: "nl",
    isOliviasTeam: true,
  },
  {
    ...
    tenureYears: 6,
    languages: ["English", "Bahasa", "Balinese"],
    bioOneLine: "Knows which residents take coffee black. Has never written it down.",
    shift: "on",
    photoSeed: "ap",
    isOliviasTeam: true,
  },
  {
    ...
    bioOneLine: "Open-water swimmer, Channel-crossing in 2022. Plans the resident swim circuit each week.",
    shift: "off",
    photoSeed: "ra",
  },
  {
    ...
    department: "Wellness",
    tenureYears: 3,
    languages: ["English", "Hindi", "Bahasa"],
    bioOneLine: "Crystal bowls + gamelan. Plays one full-moon sound bath each lunar cycle.",
    shift: "off",
    photoSeed: "ak",
  },
  {
    ...
    tenureYears: 5,
    languages: ["English", "Bahasa", "Mandarin", "Japanese"],
    bioOneLine: "Knows every restaurant in Bukit. Has a quiet relationship with every villa caretaker.",
    shift: "responding",
    photoSeed: "mt",
    isOliviasTeam: true,
  },
  {
    ...
    bioOneLine: "Believes a long table is the most undervalued infrastructure in luxury hospitality.",
    shift: "on",
    photoSeed: "sv",
  },
  {
    ...
    firstName: "Chen",
    lastName: "Wei",
    role: "Garden + permaculture",
    department: "Kitchen",
    tenureYears: 4,
    languages: ["Mandarin", "English", "Bahasa"],
    bioOneLine: "Walked every meter of the property before the first stone was laid.",
    shift: "on",
    photoSeed: "cw",
  },
  {
    ...
    department: "Concierge",
    tenureYears: 1,
    languages: ["English", "Bahasa", "German"],
    bioOneLine: "Came from Aman. Says the only thing better than a good morning is a quiet afternoon.",
    shift: "on",
    photoSeed: "es",
  },
];
